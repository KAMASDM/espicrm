...
class ielts_Exam(models.Model):
    Listening = models.FloatField(default=0,validators=[MinValueValidator(0), MaxValueValidator(9)])
    Reading = models.FloatField(default=0,validators=[MinValueValidator(0), MaxValueValidator(9)])
    Writing = models.FloatField(default=0,validators=[MinValueValidator(0), MaxValueValidator(9)])
    Speaking = models.FloatField(default=0,validators=[MinValueValidator(0), MaxValueValidator(9)])

    @property
    def Overall(self):
        return (self.Listening + self.Reading + self.Writing + self.Speaking) / 4

    overall_score_validator = MinValueValidator(0) and MaxValueValidator(9)
    
    overall = models.FloatField(default=0,validators=[overall_score_validator])
    def __str__(self):
        return f"Overall: {self.Overall}"
...
class Toefl_Exam(models.Model):
    ...
    Overall = models.FloatField(validators=[MinValueValidator(0), MaxValueValidator(120)])  # Maximum marks are 120
...
class PTE_Exam(models.Model):
    Speaking = models.FloatField(validators=[MinValueValidator(10), MaxValueValidator(90)])
    Writing = models.FloatField(validators=[MinValueValidator(10), MaxValueValidator(90)])
    Reading = models.FloatField(validators=[MinValueValidator(10), MaxValueValidator(90)])
    Listening = models.FloatField(validators=[MinValueValidator(10), MaxValueValidator(90)])
    @property
    def Overall(self):
        # Calculate overall PTE score as the average of the four section scores
        return (self.Speaking + self.Writing + self.Reading + self.Listening) / 4
...
class Gre_Exam(models.Model):
    ...
    Analytical = models.FloatField(validators=[MinValueValidator(0), MaxValueValidator(6)])  # Analytical Writing score ranges from 0 to 6
    Overall = models.FloatField(default=0,validators=[MinValueValidator(260), MaxValueValidator(340)])
...
class Gmat_Exam(models.Model):
    ...
    Analytical = models.FloatField(validators=[MinValueValidator(0), MaxValueValidator(6)])  # Analytical Writing score ranges from 0 to 6
    Overall = models.FloatField(default=0,validators=[MinValueValidator(200), MaxValueValidator(800)])
