...
from Master.models import twelfth_std_percentage_requirement, bachelor_requirement, masters_requirement, tenth_std_percentage_requirement, \
    ...
    Payment_Status, Payment_Mode, CountryInterested,DetailEnquiryFollowupStatus,EnquiryFollowupStatus,AssesmentFollowupStatus,PaymentFollowupStatus
...
admin.site.register(EnquiryFollowupStatus)
admin.site.register(DetailEnquiryFollowupStatus)
admin.site.register(AssesmentFollowupStatus)
admin.site.register(PaymentFollowupStatus)
