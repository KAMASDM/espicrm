...
class Detail_Enquiry(models.Model):
    ...
    Toefl_Exam = models.ForeignKey(Toefl_Exam, on_delete=models.CASCADE, blank=True,  )
    ielts_Exam = models.ForeignKey(Ielts_Exam, on_delete=models.CASCADE, blank=True,  )
    PTE_Exam = models.ForeignKey(PTE_Exam, on_delete=models.CASCADE, blank=True,  )
    Duolingo_Exam = models.ForeignKey(Duolingo_Exam, on_delete=models.CASCADE, blank=True,  null=True)
    Gre_Exam = models.ForeignKey(Gre_Exam, on_delete=models.CASCADE, blank=True,  )
    Gmat_Exam = models.ForeignKey(Gmat_Exam, on_delete=models.CASCADE, blank=True,  )
    Father_Occupation = models.CharField(max_length=100, blank=True,  )
    Father_Annual_Income = models.FloatField(blank=True,  )
    Refusal = models.ForeignKey(Rejection_Reason, on_delete=models.CASCADE, blank=True,  )
    ...
    Enquiry_Status = models.ForeignKey(Detail_Enquiry_Status, on_delete=models.CASCADE, blank=True,  )
