...
from Master.views import  (CountryInterestedViewSet, CountryViewSet ,CourseLevelsViewSet,AvailableServicesViewSet, CurrentEducationViewSet, IntakeViewSet,DocumentsRequiredViewSet, CourseRequirementsViewSet, EnquiryStatusViewSet,
    AssessmentStatusViewSet, ApplicationStatusViewSet, UniversityViewSet,
    CourseViewSet, EduLevelViewSet, WorkExperienceViewSet,
    ...
    PaymentStatusViewSet, PaymentModeViewSet, ToeflExamViewSet, IeltsExamViewSet,
    PTEExamViewSet, DuolingoExamViewSet, GreExamViewSet, GmatExamViewSet)
    
router = routers.DefaultRouter()
router.register('countryinterested', CountryInterestedViewSet)
